...
//Type Location Name
$lang['receivings_start_typing_location_name'] = '转移到位置';
...
$lang['receivings_start_typing_location_name_from'] = '从位置转移';
$lang['receivings_last_receiving_receipt'] = '显示最后收货';
$lang['receivings_send_transfer_request'] = '发送转移请求';
$lang['receivings_confirm_finish_receiving_transfer_request'] = '您确定要提交此转移请求吗？';
$lang['receivings_incoming_transfers'] = '传入转账';

$lang['receivings_signature'] = '收据签名';

$lang['receivings_show_signature_on_receiving_receipt'] = '在收据上显示签名';

$lang['receivings_out_of_stock'] = '完成此交易时，一件或多件物品将无库存';
$lang['receivings_you_do_not_have_permission_to_complete_transfers'] = '您无权完成转移。您需要联系经理以获取许可';
$lang['receivings_undelete_unsuccessful'] = '无法删除接收';
$lang['delete_suspended_receivings_confirmation'] = '您确定要删除此接收，此操作无法撤消。';
?>