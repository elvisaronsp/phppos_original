					...
					<div class="col-md-12">
						...
						<div class="form-group">
							...
							<div class="col-sm-9 col-md-9 col-lg-10">
								...
								echo form_dropdown('delivery_employee_person_id', $employees, $delivery_info['delivery_employee_person_id'], 'class="form-control form-inps" id="delivery_employee_person_id"'); ?>
